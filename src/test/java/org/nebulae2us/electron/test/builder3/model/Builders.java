...
public class Builders {
    ...
    public static BookBuilder<?> book$copyFrom(Book book) {
    	BookBuilder<?> result = new Converter(DESTINATION_CLASS_RESOLVER, false).convert(book).to(BookBuilder.class);
    	return result;
    }
    
    public static BookBuilder<?> wrap(Book book) {
    	return new WrapConverter(DESTINATION_CLASS_RESOLVER).convert(book).to(BookBuilder.class);
    }
    ...
    public static ColorBuilder<?> color$copyFrom(Color color) {
    	ColorBuilder<?> result = new Converter(DESTINATION_CLASS_RESOLVER, false).convert(color).to(ColorBuilder.class);
    	return result;
    }
    
    public static ColorBuilder<?> wrap(Color color) {
    	return new WrapConverter(DESTINATION_CLASS_RESOLVER).convert(color).to(ColorBuilder.class);
    }
    ...
    public static PaperBuilder<?> paper$copyFrom(Paper paper) {
    	PaperBuilder<?> result = new Converter(DESTINATION_CLASS_RESOLVER, false).convert(paper).to(PaperBuilder.class);
    	return result;
    }
    
    public static PaperBuilder<?> wrap(Paper paper) {
    	return new WrapConverter(DESTINATION_CLASS_RESOLVER).convert(paper).to(PaperBuilder.class);
    }
    ...
    public static CopyPaperBuilder<?> copyPaper$copyFrom(CopyPaper copyPaper) {
    	CopyPaperBuilder<?> result = new Converter(DESTINATION_CLASS_RESOLVER, false).convert(copyPaper).to(CopyPaperBuilder.class);
    	return result;
    }
    
    public static CopyPaperBuilder<?> wrap(CopyPaper copyPaper) {
    	return new WrapConverter(DESTINATION_CLASS_RESOLVER).convert(copyPaper).to(CopyPaperBuilder.class);
    }
    ...
    public static FictionBuilder<?> fiction$copyFrom(Fiction fiction) {
    	FictionBuilder<?> result = new Converter(DESTINATION_CLASS_RESOLVER, false).convert(fiction).to(FictionBuilder.class);
    	return result;
    }
    
    public static FictionBuilder<?> wrap(Fiction fiction) {
    	return new WrapConverter(DESTINATION_CLASS_RESOLVER).convert(fiction).to(FictionBuilder.class);
    }
    ...
    public static RGBColorBuilder<?> rGBColor$copyFrom(RGBColor rGBColor) {
    	RGBColorBuilder<?> result = new Converter(DESTINATION_CLASS_RESOLVER, false).convert(rGBColor).to(RGBColorBuilder.class);
    	return result;
    }
