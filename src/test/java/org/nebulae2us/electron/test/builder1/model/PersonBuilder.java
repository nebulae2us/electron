...
public class PersonBuilder<P> implements Wrappable<Person> {
    ...
    public Person toPerson() {
    	return new Converter(new DestinationClassResolverByAnnotation(), true, Builders.IGNORED_TYPES).convert(this).to(Person.class);
    }
	...
	public int getAge() {
		if (this.$$$wrapped != null && WrapHelper.valueNotSet(this.age, int.class)) {
			...
			this.age = new WrapConverter(Builders.DESTINATION_CLASS_RESOLVER, Builders.IGNORED_TYPES).convert(o).to(int.class);
		}
	...
	public Gender getGender() {
		if (this.$$$wrapped != null && WrapHelper.valueNotSet(this.gender, Gender.class)) {
			...
			this.gender = new WrapConverter(Builders.DESTINATION_CLASS_RESOLVER, Builders.IGNORED_TYPES).convert(o).to(Gender.class);
		}
	...
	public PersonBuilder<?> getParent() {
		if (this.$$$wrapped != null && WrapHelper.valueNotSet(this.parent, PersonBuilder.class)) {
			...
			this.parent = new WrapConverter(Builders.DESTINATION_CLASS_RESOLVER, Builders.IGNORED_TYPES).convert(o).to(PersonBuilder.class);
		}
    ...
    public PersonBuilder<P> parent$wrap(Person parent) {
    	verifyMutable();
    	this.parent = new WrapConverter(Builders.DESTINATION_CLASS_RESOLVER, Builders.IGNORED_TYPES).convert(parent).to(PersonBuilder.class);
        return this;
    }
	...
	public List<PersonBuilder<?>> getChildren() {
		if (this.$$$wrapped != null && WrapHelper.valueNotSet(this.children, List.class)) {
			...
			this.children = new WrapConverter(Builders.DESTINATION_CLASS_RESOLVER, Builders.IGNORED_TYPES).convert(o).to(List.class);
		}
	...
	public List<HobbyBuilder<?>> getHobbies() {
		if (this.$$$wrapped != null && WrapHelper.valueNotSet(this.hobbies, List.class)) {
			...
			this.hobbies = new WrapConverter(Builders.DESTINATION_CLASS_RESOLVER, Builders.IGNORED_TYPES).convert(o).to(List.class);
		}
    ...
    public PersonBuilder<P> hobbies$wrap(Collection<? extends Hobby> hobbies) {
		...
		if (hobbies != null) {
			for (Hobby e : hobbies) {
				HobbyBuilder<?> wrapped = new WrapConverter(Builders.DESTINATION_CLASS_RESOLVER, Builders.IGNORED_TYPES).convert(e).to(HobbyBuilder.class);
	...
	public List<SpeechBuilder<?>> getSpeeches() {
		if (this.$$$wrapped != null && WrapHelper.valueNotSet(this.speeches, List.class)) {
			...
			this.speeches = new WrapConverter(Builders.DESTINATION_CLASS_RESOLVER, Builders.IGNORED_TYPES).convert(o).to(List.class);
		}
    ...
    public PersonBuilder<P> speeches$wrap(Collection<? extends Speech> speeches) {
		...
		if (speeches != null) {
			for (Speech e : speeches) {
				SpeechBuilder<?> wrapped = new WrapConverter(Builders.DESTINATION_CLASS_RESOLVER, Builders.IGNORED_TYPES).convert(e).to(SpeechBuilder.class);
	...
	public List<PersonBuilder<?>> getFriends() {
		if (this.$$$wrapped != null && WrapHelper.valueNotSet(this.friends, List.class)) {
			...
			this.friends = new WrapConverter(Builders.DESTINATION_CLASS_RESOLVER, Builders.IGNORED_TYPES).convert(o).to(List.class);
		}
