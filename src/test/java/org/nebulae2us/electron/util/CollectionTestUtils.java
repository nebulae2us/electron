...
public class CollectionTestUtils {
	...
	public static <E> void testToArray(Class<E> elementClass, List<E> control, List<E> test) {
	...
	private static <E> void testContains(List<E> control, List<E> test) {
		for (int i = 0; i < control.size(); i++) {
			assertTrue(test.contains(control.get(i)));
		}
	}
	...
	private static <E> void testIterator(List<E> control, List<E> test) {
